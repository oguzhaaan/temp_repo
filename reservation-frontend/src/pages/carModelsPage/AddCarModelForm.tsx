...
interface CreateCarModelFormProps {
...
export const AddCarModelForm = ({
  ...
  const submitAndCreate = async () => {
    await toast.promise(API.createCarModel(form), {
      loading: "Adding Car Model...",
      success: "Car Model added successfully!",
      error: "Failed to add car model.",
    });
    refreshCarModels();
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="relative h-min w-4/5 overflow-y-auto rounded-lg bg-white p-6 shadow-lg">
        <i
          onClick={onClose}
